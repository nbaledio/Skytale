...
tutorial.prototype = {
	create: function() {
		...
		//give the villager a place to live
		...
		//set up for when instructions appear
		...
		//place the statue to provide narrative
		bigBird = new statue();
		bigBird.spawn(game);
	...
	update: function() {
		...
		//allow the statue to speak before the game continues
		if ((bigBird.interacted == 'intro' || bigBird.interacted == 'ready')) {
			...
			//give the player new instructions as they complete tasks
			...
			//instruct the player on where to go once they have finished a task
			...
			//end the level if the player chooses so
			...
			//give the player some time to read the instructions, but register them as being completed
			...
			//give instructions on how to interact
			...
			//depending on the stage of interaction with the villager,
